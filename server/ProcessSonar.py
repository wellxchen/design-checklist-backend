...
class ProcessSonar (object):
    ...
    def process(self):
        ...
        data['error']['Communication']['Concise code']["detail"] = self.message[0][5]
        ...
        data['error']['Communication']['No warning']["detail"] = self.message[0][6]
        ...
        data['error']['Modularity']['Data responsibility']["detail"] = self.message[1][0]
        ...
        data['error']['Modularity']['No public instance variables']["detail"] = self.message[1][1]
        ...
        data['error']['Modularity']['No manager classes']["detail"] = self.message[1][2]
        ...
        data['error']['Modularity']['No static variables']["detail"] = self.message[1][3]
        ...
        data['error']['Modularity']['Active classes']["detail"] = self.message[1][4]
        ...
        data['error']['Modularity']['Get method give minimum info']["detail"] = self.message[1][5]
        ...
        data['error']['Modularity']['Get method validate input']["detail"] = self.message[1][6]
        ...
        data['error']['Modularity']['Superclasses are their own class']["detail"] =  self.message[1][7]
        ...
        data['error']['Flexibility']['No duplicated code']["detail"] = self.message[2][0]

        data['error']['Flexibility']['General type'] = {}
        data['error']['Flexibility']['General type']["category description"] = categories().Modularity_sub[2]
        data['error']['Flexibility']['General type']["detail"] = self.message[2][1]
        ...
        data['error']['Flexibility']['Single Purpose']["detail"] =  self.message[2][2]
        ...
        data['error']['Flexibility']['Behavior Driven Design']["detail"] = self.message[2][3]

        data['error']['Flexibility']['Polymorphism'] = {}
        data['error']['Flexibility']['Polymorphism']["category description"] = categories().Modularity_sub[5]
        data['error']['Flexibility']['Polymorphism']["detail"] = self.message[2][4]

        data['error']['Java Notes'] = self.message[3]
        data['error']['Code Smells'] = self.message[4]
        data['percentage'] = {}
