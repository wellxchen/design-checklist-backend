...
class ProcessSonar (object):
    ...
    def process(self):
        ...
        Modularbility = {'squid:S1258', 'squid:S3066', 'squid:ClassVariableVisibilityCheck',
        	...
        	'squid:S2156'}
        Modularbility_sub = ["Tell, don't ask: classes should be responsible for their own data and delegate to other objects instead of doing it themselves",
        ...
        Flexibility_sub = ['DRY: no duplicated code, either exactly (from cutting and pasting), structurally (in flow of control or decisions), or in setup ("boilerplate" code)',
